...
public class BMSPage {
	  ...
	  public void CheckNavigationFlow() throws Exception
	  {
	      ...
	      page.waitForLoadState();
	      Thread.sleep(2000);
	      page.getByRole(AriaRole.IMG, new Page.GetByRoleOptions().setName("https://bms-prod-2024.s3.ap-south-1.amazonaws.com/assets/HC.svg")).hover();
	      Thread.sleep(2000);
	      page.locator(".MuiTypography-root.MuiTypography-body1.subtitle.css-intl0u").hover();
	      Thread.sleep(2000);
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Preventive")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Preventive Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Senior")).click();
		  Thread.sleep(2000);
		  ...
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Women Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Family")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Family Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Vitamin")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Vitamin Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("PCOS")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("PCOS Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Thyroid")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Thyroid Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Fitness")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Fitness Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Diabetes")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Diabetes Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Anemia")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Anemia Packages");
		  Thread.sleep(2000);
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Liver")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Liver Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Kidney")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Kidney Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Cardiac")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Cardiac Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Arthritis")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Arthritis Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Fever")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Fever Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Hairfall")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Hairfall Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Men").setExact(true)).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Men Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Allergy")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Allergy Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Infertility")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Infertility Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Cancer")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Cancer Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Bone Health")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Bone Health Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Gut Health")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Gut Health Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Hepatitis")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Hepatitis Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("STD")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("STD Packages");
	      page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Antenatal")).click();
		  Thread.sleep(2000);
	      assertThat(page.getByRole(AriaRole.MAIN)).containsText("Antenatal Packages");
	      page.getByText("BOOK MY SCANS", new Page.GetByTextOptions().setExact(true)).nth(1).click();
	  }
  }
